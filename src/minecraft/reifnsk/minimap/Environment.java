...
class Environment {
    ...
    private static void calcEnvironment(int x, int z, Environment environment) {
        double noise = noiseGen.func_4112_a((double[])null, (double)x, (double)z, 1, 1, 0.25D, 0.25D, 0.5882352941176471D)[0] * 1.1D + 0.5D;
        double temperature = temperatureGen.func_4112_a((double[])null, (double)x, (double)z, 1, 1, 0.02500000037252903D, 0.02500000037252903D, 0.25D)[0];
        ...
        double humidity = humidityGen.func_4112_a((double[])null, (double)x, (double)z, 1, 1, 0.05000000074505806D, 0.05000000074505806D, 0.3333333333333333D)[0];
