...
public class GLTextureBufferedImage extends BufferedImage {
    private static final ByteBuffer buffer = GLAllocation.createDirectByteBuffer(4194304);
    private static final IntBuffer singleIntBuffer = GLAllocation.createDirectIntBuffer(1);
