            ...
            for(int blockID = 0; blockID < BLOCK_NUM; ++blockID) {
                ...
                if (block != null) {
                    ...
                    for(int meta = 0; meta < 16; ++meta) {
                        ...
                        try {
                            s = StringTranslate.getInstance().translateNamedKey((new ItemStack(block, 1, meta)).getItemName());
                        } catch (Exception var16) {
                        }

                        if (s == null || s.isEmpty()) {
                            s = StringTranslate.getInstance().translateNamedKey(block.getBlockName());
                        }
