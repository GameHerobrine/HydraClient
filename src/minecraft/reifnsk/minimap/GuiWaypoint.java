...
class GuiWaypoint extends GuiButton {
    ...
    public void drawButton(Minecraft minecraft, int i, int j) {
        if (this.waypoint != null) {
            ...
            this.drawString(fontRenderer, this.name, this.xPosition + 1, this.yPosition + 1, (hover ? COLOR1 : COLOR2)[this.waypoint.type]);
            ...
            this.drawRect(this.cleft, this.ctop, this.cright, this.cbottom, color);
            ...
            this.drawRect(this.bleft, this.btop, this.bright, this.bbottom, color);
            ...
            if (tooltip) {
                ...
                this.drawRect(drawLeft, j - 11, drawRight, j - 1, -1610612736);
