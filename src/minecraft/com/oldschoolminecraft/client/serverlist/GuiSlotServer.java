...
import com.oldschoolminecraft.client.serverlist.ServerData;
import com.oldschoolminecraft.client.serverlist.ThreadPollProxy;
import com.oldschoolminecraft.client.serverlist.ThreadPollServers;
...
public class GuiSlotServer extends GuiSlot
{
    ...
    {
        super(Client.getInstance().mc, guimultiplayer.width, guimultiplayer.height, 32, guimultiplayer.height - 64, 36);
        menu = guimultiplayer;
    }
    ...
    protected void drawSlot(int i, int j, int k, int l, Tessellator tessellator)
    {
        ...
        menu.drawString(fr, server.name, j + 2, k + 1, 0xffffff);
        menu.drawString(fr, server.status, j + 2, k + 12, 0x808080);
        menu.drawString(fr, server.playerCount, (j + 215) - fr.getStringWidth(server.playerCount), k + 12, 0x808080);
        menu.drawString(fr, server.ip, j + 2, k + 12 + 11, 0x303030);
        int i1 = 0;
        int j1 = 0;
        String s = null;
