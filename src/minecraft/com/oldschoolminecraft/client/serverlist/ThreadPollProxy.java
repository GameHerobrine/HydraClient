    ...
    public void run() {
        try {
            ...
            try {
                ...
                catch(Exception e) {server.setConnectionFailed(e.getMessage());}
            } finally {
            ...
            if(e.getMessage().equalsIgnoreCase("Received fatal alert: protocol_version")) {
                server.setConnectionFailed("com.oldschoolminecraft.client.serverlist.ThreadPollProxy must be compiled in Java 8");
            }
            else {
